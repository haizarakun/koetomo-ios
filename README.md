...
<p align="center">
  <img alt="version" src="https://img.shields.io/badge/version-1.03%20beta-blue">
...
1. iPhone の **Safari** で次の URL を開き、IPA をダウンロード（「ダウンロード」を許可）
   ...
   ```
   https://raw.githubusercontent.com/haizarakun/koetomo-ios/main/ipa/KoeTomoPlus_v1.03.ipa
   ```

2. 「ファイル」アプリ → ダウンロード → `KoeTomoPlus_v1.03.ipa` をタップ → 共有 → **TrollStore**
...
- **TrollStore (iOS 14.0–16.6.1 / 17.0):** download `https://raw.githubusercontent.com/haizarakun/koetomo-ios/main/ipa/KoeTomoPlus_v1.03.ipa` in Safari and open it with TrollStore.
